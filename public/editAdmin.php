...
if($admin != 'superadmin'){
	...
	$view = $administrator->select_by_id($id);
	if($view == []){
...
$username = isset($_POST['username']) ? $_POST['username'] : $view[0]['username'];
$password = isset($_POST['password']) ? $_POST['password'] : '';
$type = isset($_POST['type']) ? $_POST['type'] : $view[0]['type'];
